...
### Ready
- 🔹 [DTL-009: Update LookMLGenerator to accept and propagate convert_tz settings](issues/DTL-009.md) `feature`
- 🔹 [DTL-019: Add validation preview and confirmation step](issues/DTL-019.md) `feature`
- 🔹 [DTL-028: Add comprehensive tests for cross-entity metrics](issues/DTL-028.md) `testing`
- 🔹 [DTL-018: Build simple prompt-based wizard for generate command](issues/DTL-018.md) `feature`
- 🔹 [DTL-003: Generate dimension-only field sets in views](issues/DTL-003.md) `feature`
...
- 🔹 [DTL-026: Update explore generation for metric requirements](issues/DTL-026.md) `feature`
- 🔹 [DTL-012: Update integration and golden tests](issues/DTL-012.md) `feature`
