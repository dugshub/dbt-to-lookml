...
class TestEntityAdvanced:
    """Advanced test cases for Entity model."""
...
class TestDimensionAdvanced:
    """Advanced test cases for Dimension model."""
...
class TestMeasureAdvanced:
    """Advanced test cases for Measure model."""
...
class TestSemanticModelAdvanced:
    """Advanced test cases for SemanticModel."""
